# orbit-scholar — Research Intelligence Studio

Researches multi-faceted topics and synthesises findings into structured reports
using Orbit Rover's two-tier ralph loop pattern.
