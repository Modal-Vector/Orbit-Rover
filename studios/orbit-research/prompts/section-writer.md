...
1. Read the context files listed in the task (research findings from `findings/`)
2. Write the section to `output/` following the task description
3. Verify the output meets the acceptance criteria
4. Mark the task as `done: true` in `write-tasks.json`
